...
REM
REM Generated by Vivado on Tue Dec 24 00:02:02 +0800 2024
...
echo "xvlog --incr --relax -prj SingleCycleTop_vlog.prj"
call xvlog  --incr --relax -prj SingleCycleTop_vlog.prj -log xvlog.log
